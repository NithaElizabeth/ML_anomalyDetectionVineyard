...
parser.add_argument("--input", "-i",   required=True,
                    help="The location of the input video file")
parser.add_argument("--date", "-d",  required=True,
                    help="The date when the video was taken")
parser.add_argument("--name", "-n",  required=True,
                    help="Name of the customer")
parser.add_argument("--parcel", "-p",  required=True,
                    help="The Parcel Number")
...
dirName = str(args.date) + "_" + str(args.name) + "_" + \
    str(args.parcel) + "_" + str(args.right) + "_" + str(args.left)
...
# f = open('data/last_num.pickle', 'wb')
# pickle.dump(start, f)
# f.close()
...
with open(logFileName, "w") as f:
    f.write("Location of video: " + 'static/input/' + str(args.input))
f.close()

print("Directory Name: " + dirName)
print("File Prefix:    " + filePrefix)

cap = cv2.VideoCapture('static/input/' + str(args.input))
